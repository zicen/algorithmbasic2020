...
public class Code02_IsPalindromeList {
    ...
    // need n/2 extra space  1 2 3 3 2 1     1 2 1
    ...
    public static boolean isPalindrome4(Node head) {
        ...
        Node swapedNode = swapNode(mid.next);
        Node tmpHead = head;
        boolean res = true;
        while (swapedNode != null) {
            if (swapedNode.value != tmpHead.value) {
                res = false;
                break;
            }
            swapedNode = swapedNode.next;
